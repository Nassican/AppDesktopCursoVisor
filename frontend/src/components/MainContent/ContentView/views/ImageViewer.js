...
const ImageViewer = ({ filePath, fileName }) => {
  ...
  return (
    <div className="relative flex-1 bg-blue-50 rounded-lg overflow-hidden border border-gray-200">
      {isLoading && (
        ...
        {({ zoomIn, zoomOut, resetTransform }) => (
          <>
            <div className="absolute top-4 right-4 flex gap-2 z-50">
              <button
                onClick={() => zoomIn(0.2)}
                className="bg-gray-800/50 hover:bg-gray-800/70 text-white p-2 rounded-lg"
              >

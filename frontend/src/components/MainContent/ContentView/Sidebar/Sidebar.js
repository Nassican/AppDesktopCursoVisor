...
const Sidebar = ({ structure, renderTree, goToHome, isOpen, onToggle }) => {
  return (
    <div
      className={`
        fixed md:relative
        h-full ease-in-out flex flex-col
        ${isOpen ? "w-full md:w-[320px] lg:w-[25vw] lg:max-w-[400px]" : "w-0"}
        bg-white dark:bg-gray-900 border-r dark:border-gray-700 shadow-md overflow-hidden
        z-30
      `}
    >
      ...
      >
        {/* Header del Sidebar */}
        <div className="sticky top-0 z-10 bg-white border-b dark:border-gray-700 dark:bg-gray-900">
